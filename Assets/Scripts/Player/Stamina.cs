...
public class Stamina : Singleton<Stamina>
{
    ...
    [SerializeField] private Sprite fullStaminaImage, emptyStaminaImage; // will cause animations to prompt Stamina option
    [SerializeField] private int timeBetweenStaminaRefresh = 10;
